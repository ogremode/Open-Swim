...
NEXT_EPISODES_ACTIVE = 0 # Set NEXT_EPISODES_ACTIVE to 0 to enable this feature. Set NEXT_EPISODES_ACTIVE to 1 to disable this feature.
...
RERUNS_ACTIVE = 0 # Set RERUNS_ACTIVE to 0 to enable this feature. Set RERUNS_ACTIVE to 1 to disable this feature.
...
PROMO_ACTIVE = 0 # Set PROMO_ACTIVE to 0 to enable this feature. Set PROMO_ACTIVE to 1 to disable this feature.
...
BUMPER_ACTIVE = 0 # Set BUMPER_ACTIVE to 0 to enable this feature. Set BUMPER_ACTIVE to 1 to disable this feature.
...
BLOCK_PREROLL_ACTIVE = 0 # Set BLOCK_PREROLL_ACTIVE to 0 to enable this feature. Set BLOCK_PREROLL_ACTIVE to 1 to disable this feature.
...
# Movie set up 
MOVIE_ACTIVE = 1 # Set MOVIE_ACTIVE to 0 to enable this feature. Set MOVIE_ACTIVE to 1 to disable this feature. If movies are disabled, all the features below are also disabled.
...
PRESHOW_CARTOON_ACTIVE = 1 # Set PRESHOW_CARTOON_ACTIVE to 0 to enable this feature. Set PRESHOW_CARTOON_ACTIVE to 1 to disable this feature.
...
TRAILER_ACTIVE = 1 # Set PREROLL_ACTIVE to 0 to enable this feature. Set PREROLL_ACTIVE to 1 to disable this feature.
